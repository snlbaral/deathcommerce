...
<div class="row">
    ...
    {{-- <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {{ Form::number('price', 0, ['class' => 'form-control','id' => 'monthly_price','min' => '0','placeholder' => __('Enter Price'),'required' => 'required']) }}
            </div>
        </div>
    </div> --}}
    {{-- <div class="col-md-6">
    ...
    <div class="form-group col-md-6">
        ...
        <div class="input-group">
            {{ Form::number('trial_days', 0, ['class' => 'form-control','id' => 'trial_days','min' => '0','placeholder' => __('Enter Trial Days'),'required' => 'required']) }}
    ...
    <div class="form-group col-md-12">
        ...
        {!! Form::select('status', [""=>"Select Plan Status","0"=>"Inactive","1"=>"Active"], null, ['class' => 'form-control ', 'required' => 'required']) !!}
    </div>
    <div class="col-6">
