...
<div class="row">
    ...
    <div class="col-md-12">        
        <div class="form-group row">
            {{ Form::label('default_pricing', __('Default Price'), ['class' => 'col-form-label']) }}
            <div class="col-md-6">
                <div class="input-group mb-3">
                    <span class="input-group-text">{{ env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$' }}</span>
                    <input type="number" value="{{$plan->defaultMonthlyPrice()}}" name="monthly_price" class="form-control" required>
            ...
            <div class="col-md-6">
                <div class="input-group mb-3">
                    <span class="input-group-text">{{ env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$' }}</span>
                    <input type="number" value="{{$plan->defaultYearlyPrice()}}" name="yearly_price" class="form-control" required>
    ...
    <script>
        $("input[name='monthly_price']").on("keyup", function() {
            const value = parseFloat($(this).val());
            if (!isNaN(value)) {
                $("input[name='yearly_price']").val(value*12)
            }
        })
    </script>
    ...
    <div class="form-group col-md-6">
        {{ Form::label('trial_days', __('Trial Days'), ['class' => 'col-form-label']) }}
        <div class="input-group">
            {{ Form::number('trial_days', null, ['class' => 'form-control','id' => 'trial_days','min' => '0','placeholder' => __('Enter Trial Days'),'required' => 'required']) }}
    ...
    <div class="form-group col-md-12">
        ...
        {!! Form::select('status', [""=>"Select Plan Status","0"=>"Inactive","1"=>"Active"], null, ['class' => 'form-control ', 'id'=>'status', 'required' => 'required']) !!}
    </div>
    <div class="col-6">
