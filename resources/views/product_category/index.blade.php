                                    ...
                                    <td>
                                        <div class="d-flex">
                                            @can('Edit Product category')
                                                <a class="btn btn-sm btn-icon  bg-light-secondary me-2" data-url="{{ route('product_categorie.edit', $product_category->id) }}"  data-ajax-popup="true" data-title="{{ __('Edit Category') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Edit') }}" data-tooltip="Edit">
                                                    <i class="ti ti-edit f-20"></i>
                                                </a>
                                            @endcan
                                            @can('Delete Product category')
                                                <a class="bs-pass-para btn btn-sm btn-icon bg-light-secondary" data-title="{{ __('Delete Lead') }}" data-confirm="{{ __('Are You Sure?') }}"  data-text="{{ __('This action can not be undone. Do you want to continue?') }}" data-confirm-yes="delete-form-{{ $product_category->id }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Delete') }}">
