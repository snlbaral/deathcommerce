...
@section('content')
                                        ...
                                        @foreach ($products['products'] as $key => $product)
                                            @if ($product['variant_id'] != 0)
                                                <tr data-id="{{$key}}">
                                                    ...
                                                    <td data-label="Name">
                                                        <a href="{{route('store.product.product_view',[$store->slug,$product['id']])}}">{{$product['product_name'] .' - '. $product['variant_name']}}</a>
                                                    </td>
                                                    ...
                                                    <td data-label="quantity">
                                                        <div class="qty-spinner" data-id="{{$key}}">
                                                            ...
                                                            <input type="text" class="quantity product_qty_input bx-cart-qty" data-cke-saved-name="quantity" name="quantity" data-id="{{$product['product_id']}}" value="{{$product['quantity']}}" id="product_qty">
                                                        ...
                                                        @if(!empty($product['tax']))
                                                            @foreach($product['tax'] as $tax)
                                                                @php
                                                                    ...
                                                                    $total_tax += $sub_tax;
                                                                @endphp
                                                                <p> {{$tax['tax_name'].' '.$tax['tax'].'%'.' ('.$sub_tax.')'}}</p>
                                                            @endforeach
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td data-label="Total">
                                                        @php
                                                            ...
                                                            $total += $totalprice;
                                                        @endphp
                                                        <p>{{\App\Models\Utility::priceFormat($totalprice)}}</p>
                                            ...
                                            @else
                                                <tr data-id="{{$key}}">
                                                    ...
                                                    <td data-label="Total">
                                                        ...
                                                        @endphp
                                                        <p>{{\App\Models\Utility::priceFormat($totalprice)}}</p>
                                                        <a href="#" class="remove-btn" data-toggle="tooltip" data-original-title="{{__('Move to trash')}}" data-confirm="{{__('Are You Sure?').' | '.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-product-cart-{{$key}}').submit();"><i class="fas fa-times"></i></a>
                                                        {!! Form::open(['method' => 'DELETE', 'route' => ['delete.cart_item',[$store->slug,$product['product_id'],$product['variant_id']]],'id'=>'delete-product-cart-'.$key]) !!}
                                                        {!! Form::close() !!}
                                                    </td>
                                                </tr> 
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 col-12">
                                <div class="price-bar">
                                    ...
                                    <span>{{\App\Models\Utility::priceFormat(!empty($total)?$total:0)}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    @else
        <div class="wrapper">
            <section class="empty-cart-section padding-top">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-md-12 col-12">
                            <div class="empty-cart">
                                <svg id="8fc77738-ee79-4216-bfe1-e1f5c470859a" data-name="Layer 1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="1015.56" height="783.53" viewBox="0 0 1015.56 783.53">
                                    <defs>
                                        <linearGradient id="55e18adb-5a4b-48dc-a3c1-f250c98f7014" x1="535.54" y1="705.46"
                                            x2="535.54" gradientUnits="userSpaceOnUse">
                                            <stop offset="0" stop-color="gray" stop-opacity="0.25" />
                                            <stop offset="0.54" stop-color="gray" stop-opacity="0.12" />
                                            <stop offset="1" stop-color="gray" stop-opacity="0.1" />
                                        </linearGradient>
                                        <linearGradient id="dcaa3d52-8271-46b6-bbc0-03906cb73c47" x1="237.19" y1="818.89"
                                            x2="237.19" y2="359.58" xlink:href="#55e18adb-5a4b-48dc-a3c1-f250c98f7014" />
                                    </defs>
                                    ...
                                    <path
                                        ...
                                        transform="translate(-92.22 -58.23)" class="fill-primary" opacity="0.1" />
                                    <ellipse cx="135.74" cy="756.99" rx="135.74" ry="26.54" class="fill-primary"
                                        opacity="0.1" />
                                    <ellipse cx="538.99" cy="701.56" rx="284.54" ry="26.54" class="fill-primary"
                                        opacity="0.1" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        transform="translate(-92.22 -58.23)" class="fill-primary" />
                                    <path
                                    ...
                                    <path
                                        d="M1042.73,387.12c-6.85,6.64-38.73,13.51-38.73,13.51s7.83-31.65,14.67-38.3a17.27,17.27,0,0,1,24.06,24.79Z"
                                        transform="translate(-92.22 -58.23)" opacity="0.25" />
                                    <path
                                        d="M1024.7,444.41c-9.36,1.85-39.85-9.71-39.85-9.71s23.77-22.32,33.12-24.18a17.28,17.28,0,1,1,6.73,33.89Z"
                                        transform="translate(-92.22 -58.23)" opacity="0.25" />
                                    <path
                                    ...
                                    <polygon
                                        ...
                                        fill="url(#55e18adb-5a4b-48dc-a3c1-f250c98f7014)" />
                                    <rect x="286.29" y="6.19" width="498.5" height="26.89" fill="#f6f7f9" />
                                    <g opacity="0.2">
                                        <rect x="286.29" y="6.19" width="498.5" height="26.89" class="fill-primary" />
                                    </g>
                                    <rect x="286.29" y="33.08" width="498.5" height="666.19" fill="#f6f7f9" />
                                    <circle cx="299.4" cy="19.63" r="4.56" fill="#f6f7f9" />
                                    <circle cx="311.76" cy="19.63" r="4.56" fill="#f6f7f9" />
                                    <circle cx="324.12" cy="19.63" r="4.56" fill="#f6f7f9" />
                                    <g opacity="0.2">
                                        <rect x="375.26" y="74.15" width="320.55" height="12.55" class="fill-primary" />
                                    </g>
                                    <rect x="653.22" y="74.15" width="42.59" height="12.55" class="fill-primary" />
                                    <g opacity="0.2">
                                        <rect x="329.32" y="330.62" width="201.72" height="144.49" class="fill-primary"
                                            opacity="0.2" />
                                    </g>
                                    <g opacity="0.2">
                                        <rect x="329.32" y="143.19" width="201.72" height="144.49" class="fill-primary"
                                            opacity="0.2" />
                                    </g>
                                    <g opacity="0.2">
                                        <rect x="329.32" y="515.61" width="201.72" height="144.49" class="fill-primary"
                                            opacity="0.2" />
                                    </g>
                                    <g opacity="0.2">
                                        <rect x="540.04" y="330.62" width="201.72" height="144.49" class="fill-primary"
                                            opacity="0.2" />
                                    </g>
                                    <g opacity="0.2">
                                        <rect x="540.04" y="143.19" width="201.72" height="144.49" class="fill-primary"
                                            opacity="0.2" />
                                    </g>
                                    <g opacity="0.2">
                                        <rect x="540.04" y="515.61" width="201.72" height="144.49" class="fill-primary"
                                            opacity="0.2" />
                                    </g>
                                    <path
                                        d="M1023.79,692.73s7.14,9.33-3.29,23.41-19,26-15.55,34.76c0,0,15.73-26.16,28.54-26.52S1037.88,708.46,1023.79,692.73Z"
                                        transform="translate(-92.22 -58.23)" fill="#3acc6c" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        transform="translate(-92.22 -58.23)" fill="#ffd037" />
                                    <ellipse cx="912.73" cy="752.6" rx="74.6" ry="11.45" class="fill-primary"
                                        opacity="0.1" />
                                    <path
                                        ...
                                        transform="translate(-92.22 -58.23)" fill="#65617d" />
                                    ...
                                    <path
                                        ...
                                        transform="translate(-92.22 -58.23)" class="fill-primary" />
                                    <circle cx="642.65" cy="188.48" r="3.66" opacity="0.1" />
                                    <circle cx="642.65" cy="187.56" r="3.66" class="fill-primary" />
                                    ...
                                    <g opacity="0.5">
                                        ...
                                        <path
                                            ...
                                            transform="translate(-92.22 -58.23)" class="fill-primary" />
                                        <circle cx="646.07" cy="364.87" r="2.31" opacity="0.1" />
                                        <circle cx="646.07" cy="363.99" r="2.31" fill="none" class="stroke-primary"
                                    ...
                                    <rect x="449.23" y="655.13" width="88.12" height="0.69"
                                        transform="translate(-296.91 1028.29) rotate(-84.73)" opacity="0.1" />
                                    <rect x="467.99" y="657.45" width="92.39" height="0.69"
                                        transform="translate(-237.83 1111.17) rotate(-89.78)" opacity="0.1" />
                                    <path d="M535.18,611.6" transform="translate(-92.22 -58.23)" fill="none"
                                        class="stroke-primary" stroke-miterlimit="10" />
                                    <rect x="536.56" y="611.56" width="0.69" height="92.8"
                                        transform="translate(-116.25 -37.87) rotate(-2.13)" opacity="0.1" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        transform="translate(-92.22 -58.23)"
                                        fill="url(#dcaa3d52-8271-46b6-bbc0-03906cb73c47)" />
                                    <path
                                        ...
                                        transform="translate(-92.22 -58.23)" fill="#ecb4b6" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        transform="translate(-92.22 -58.23)" fill="#c17174" />
                                    <circle cx="146.96" cy="735.39" r="0.94" fill="#fff" opacity="0.25" />
                                    <circle cx="155.8" cy="739.77" r="0.94" fill="#fff" opacity="0.25" />
                                    <circle cx="160.34" cy="741.8" r="0.94" fill="#fff" opacity="0.25" />
                                    <circle cx="169.77" cy="745.42" r="0.94" fill="#fff" opacity="0.25" />
                                    <circle cx="164.97" cy="743.88" r="0.94" fill="#fff" opacity="0.25" />
                                    <path
                                    ...
                                    <path
                                        d="M279.42,811.87a29.34,29.34,0,0,1-19.64,7c-13.3-.19-38.15-.58-43.92-.82-7.72-.34-5.16-6.93-4.91-11.47l48.47,3s19.85-3,21-8.92C286.21,803.87,283.65,808.21,279.42,811.87Z"
                                        transform="translate(-92.22 -58.23)" fill="#fff" opacity="0.25" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        transform="translate(-92.22 -58.23)" fill="#c17174" />
                                    <circle cx="61.77" cy="707.35" r="0.94" fill="#fff" opacity="0.25" />
                                    <circle cx="61.3" cy="714.84" r="0.94" fill="#fff" opacity="0.25" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        transform="translate(-92.22 -58.23)" fill="#ff748e" />
                                    <path
                                        d="M280.39,499.26s3.6.26,5.91-1.28,12.22-5.79,12.48-8.62c0,0,5.91,14.4,9.26,14.92,0,0-10.29,8.1-11.06,10.67s-20.84,8.88-20.84,8.88Z"
                                        transform="translate(-92.22 -58.23)" opacity="0.1" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        transform="translate(-92.22 -58.23)" fill="#5e5a6b" />
                                    <path
                                        d="M225.89,669s-12.58,16.81-17.18,18.7-38.89,43.9-38.89,43.9,7.37,13.55,20.92,15.77c0,0,7.37-2.91,10.12-9.43S225.21,713,225.21,713Z"
                                        transform="translate(-92.22 -58.23)" opacity="0.1" />
                                    ...
                                    <path
                                        ...
                                        transform="translate(-92.22 -58.23)" fill="#464353" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        transform="translate(235.71 -158.44) rotate(34.56)" fill="#9f9eff" />
                                    <rect x="334.37" y="463.08" width="0.43" height="3.77" rx="0.17" ry="0.17"
                                        transform="translate(230.62 -165.99) rotate(34.56)" fill="#464353" />
                                    <path
