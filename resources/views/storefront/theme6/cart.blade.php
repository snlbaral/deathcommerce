                                        ...
                                        @foreach ($products['products'] as $key => $product)
                                                ...
                                                <tr data-id="{{ $key }}">
                                                    ...
                                                    <td data-label="Name">
                                                        <a
                                                            ...
                                                            {{ $product['product_name'] . ' - ' . $product['variant_name'] }}</a>
                                                    </td>
                                                    <td data-label="price">
                                                    ...
                                                    <td data-label="quantity">
                                                        <div class="qty-spinner " data-id="{{ $key }}">
                                                            ...
                                                            <button type="button"
                                                                class="quantity-decrement qty-minus product_qty">
                                                            ...
                                                            <input type="text"
                                                                class="quantity product_qty_input bx-cart-qty"
                                                                data-cke-saved-name="quantity" name="quantity"
                                                                data-id="{{ $product['product_id'] }}"
                                                                value="{{ $product['quantity'] }}" id="product_qty">
                                                            <button type="button"
                                                                class="quantity-increment qty-plus product_qty">
                                                        ...
                                                        @if (!empty($product['tax']))
                                                            @foreach ($product['tax'] as $tax)
                                                                @php
                                                                    ...
                                                                    $total_tax += $sub_tax;
                                                                @endphp
                                                                <p> {{ $tax['tax_name'] . ' ' . $tax['tax'] . '%' . ' (' . $sub_tax . ')' }}
                                                                </p>
                                                            @endforeach
                                                        @else
                                                            -
                                                    ...
                                                    <td data-label="Total">
                                                        ...
                                                        <a href="#" class="action-item mr-2 remove-btn "
                                                            data-toggle="tooltip"
                                            ...
                                            @else
                                                <tr data-id="{{ $key }}">
                                                    ...
                                                    <td data-label="Name">
                                                        <a
                                                            href="{{ route('store.product.product_view', [$store->slug, $product['id']]) }}">{{ $product['product_name'] }}</a>
                                                    </td>
                                                    <td data-label="price">
                                                        {{ \App\Models\Utility::priceFormat($product['price']) }}</td>
                                                    <td data-label="quantity">
                                                        <div class="qty-spinner" data-id="{{ $key }}">
                                                            <button type="button"
                                                                class="quantity-decrement qty-minus product_qty">
                                                    ...
                                                    <td data-label="Total">
                                                        ...
                                                        @endphp
                                                        {{ \App\Models\Utility::priceFormat($totalprice) }}
                                                        <a href="#" class=" action-item remove-btn" data-toggle="tooltip"
                                                            data-original-title="{{ __('Move to trash') }}"
                                                            data-confirm="{{ __('Are You Sure?') . ' | ' . __('This action can not be undone. Do you want to continue?') }}"
                                                            data-confirm-yes="document.getElementById('delete-product-cart-{{ $key }}').submit();"><i
                        ...
                        <div class="img-wrapper">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <path
                                    ...
                                    transform="translate(-92.22 -58.23)" opacity="0.1"></path>
                                <path d="M502.83,596.8s-1.2.69,0,4" transform="translate(-92.22 -58.23)" opacity="0.1">
                                </path>
