                                ...
                                @if (!empty($products))
                                    ...
                                    @foreach ($products['products'] as $key => $product)
                                        @if ($product['variant_id'] != 0)
                                            <tr data-id="{{ $key }}">
                                                <td>
                                                    <span class="table-no">{{ $counter++ }}</span>
                                                </td> 
                                                <td data-label="Product">
                                                    <a href="{{ route('store.product.product_view', [$store->slug, $product['id']]) }}" class="pro-img-cart">
                                                ...
                                                <td data-label="quantity">
                                                    <div class="qty-spinner">
                                                        ...
                                                        <input type="text" class="quantity product_qty_input bx-cart-qty" data-cke-saved-name="quantity" data-id="{{$product['product_id']}}" value="{{$product['quantity']}}" id="product_qty"
                                                            name="quantity">
...
@else
<div class="wrapper">
    <section class="empty-cart-section padding-top padding-bottom">
...
@push('script-page')
    <script>
        ...
        $(document).on('click', '.qty-minus', function() {
            if ($(this).next().val() > 0) $(this).next().val(+$(this).next().val() );
        });
