                ...
                <div class="col-lg-7 col-md-12 col-12">
                    <div class="login-form">
                        ...
                        <?php echo Form::open(array('route' => array('customer.login', $slug,(!empty($is_cart) && $is_cart==true)?$is_cart:false)),['method'=>'POST']); ?>
                            ...
                            <div class="last-btns">
                                <button type="submit" class="btn login-btn-2 btn btn-primary"><?php echo e(__('Sign In')); ?></button>
...
<?php echo $__env->make('storefront.layout.theme3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/chacom32/deathcommerce.com/resources/views/storefront/theme3/user/login.blade.php ENDPATH**/ ?>