...
<html lang="en"  dir="<?php echo e($setting['SITE_RTL'] == 'on'?'rtl':''); ?>">
  <head>
    <title><?php echo e(__('StoreGo SaaS')); ?></title>
        ...
        <div class="row align-items-center justify-content-between">
          <div class="col-sm-6">
            ...
            <h2
              class="text-white mb-sm-4 wow animate__fadeInLeft"
              data-wow-delay="0.4s"
            ><?php echo e(__('Online Store Builder')); ?>
      ...
      <div class="container">
        ...
        <div class="row align-items-center justify-content-center mobile-screen">
            <div class="col-auto">
                ...
                <img src="<?php echo e(!empty($company_logo) ? $logo . $company_logo : $logo . 'logo-light.png'); ?>" alt ="">
        ...
        src="<?php echo e(asset('landing/images/storego-saas-pic-1.png')); ?>"
        alt=""
    ...
    <section class="">
      <div class="container">
        <div class="row align-items-center justify-content-end mb-5">
          ...
          <div class="col-sm-6">
            <img
              src="<?php echo e(asset('landing/images/storego-saas-pic-2.png')); ?>"
              alt="Datta Able Admin Template"
              class="img-fluid header-img wow animate__fadeInRight"
              data-wow-delay="0.2s"
            />
    ...
    <section class="">
      <div class="container">
        <div class="row align-items-center justify-content-end mb-5">
          ...
          <div class="col-sm-6">
            <img
              src="<?php echo e(asset('assets/images/front/img-crm-dash-3.svg')); ?>"
              alt="Datta Able Admin Template"
              class="img-fluid header-img wow animate__fadeInRight"
              data-wow-delay="0.2s"
            />
          ...
          <div class="col-xl-9 col-lg-6 col-md-12 col-sm-12">
            <div class="row feature-img-row m-auto">
              <div class="col-lg-3 col-sm-6">
                <img
                  src="<?php echo e(asset('landing/images/storego-saas-pic-3.png')); ?>"
                  class="img-fluid header-img wow animate__fadeInRight"
                  data-wow-delay="0.2s"
                  alt="Admin"
                />
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="<?php echo e(asset('landing/images/storego-saas-pic-4.png')); ?>"
                  class="img-fluid header-img wow animate__fadeInRight"
                  data-wow-delay="0.4s"
                  alt="Admin"
                />
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="<?php echo e(asset('landing/images/storego-saas-pic-5.png')); ?>"
                  class="img-fluid header-img wow animate__fadeInRight"
                  data-wow-delay="0.6s"
                  alt="Admin"
                />
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="<?php echo e(asset('landing/images/storego-saas-pic-7.png')); ?>"
                  class="img-fluid header-img wow animate__fadeInRight"
                  data-wow-delay="0.8s"
                  alt="Admin"
                />
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="<?php echo e(asset('landing/images/storego-saas-pic-9.png')); ?>"
                  class="img-fluid header-img wow animate__fadeInRight"
                  data-wow-delay="0.3s"
                  alt="Admin"
                />
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="<?php echo e(asset('landing/images/storego-saas-pic-8.png')); ?>"
                  class="img-fluid header-img wow animate__fadeInRight"
                  data-wow-delay="0.5s"
                  alt="Admin"
                />
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="<?php echo e(asset('landing/images/storego-saas-pic-6.png')); ?>"
                  class="img-fluid header-img wow animate__fadeInRight"
                  data-wow-delay="0.7s"
                  alt="Admin"
                />
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="<?php echo e(asset('landing/images/storego-saas-pic-10.png')); ?>"
                  class="img-fluid header-img wow animate__fadeInRight"
                  data-wow-delay="0.9s"
                  alt="Admin"
                />
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-sm-12">
            ...
            <img src="<?php echo e($logo . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-dark.png')); ?>" alt="logo" />
            
          </div>
          <div class="col-lg-6 col-sm-12 text-end">
            <p class="text-body"><?php echo e(__('Copyright')); ?> <?php echo e((Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :config('app.name', 'StoreGo')); ?> <?php echo e(date('Y')); ?></p>
          </div>
        </div>
      </div>
    </section>
...
<?php /**PATH /home1/chacom32/deathcommerce.com/resources/views/layouts/landing.blade.php ENDPATH**/ ?>