    ...
    <section class="cart-section">
        <div class="container">
            <div class="cart-title">
                <h2><?php echo e(__('My Cart')); ?></h2>
            </div>    
            <div class="row">
                <div class="col-12">
                    <div class="cart-tble">
                        <table class="tble-responsive"> 
                            <thead>
                            <tr>
                            ...
                            <tbody>
                                <?php if(!empty($products)): ?>
                                    ...
                                    <?php $__currentLoopData = $products['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr data-id="<?php echo e($key); ?>">
                                                <td data-label="Product">
                                                    <?php if(!empty($product['image'])): ?>
                                                        <img alt="" src="<?php echo e($imgpath.$product['image']); ?>" class="" style="width:66px;">
                                                    <?php else: ?>
                                                ...
                                                <td data-label="price"><?php echo e(\App\Models\Utility::priceFormat($product['variant_price'])); ?></td>
                                                <td data-label="quantity">
                                                    <div class="qty-spinner" data-id="<?php echo e($key); ?>">
                                                        ...
                                                        <input type="text" class="quantity product_qty_input bx-cart-qty" data-cke-saved-name="quantity" name="quantity" data-id="<?php echo e($product['product_id']); ?>" value="<?php echo e($product['quantity']); ?>" id="product_qty">
                                                ...
                                                <td data-label="Total">
                                                    ...
                                                    <a href="#" class="action-item mr-2 remove-btn" data-toggle="tooltip" data-original-title="<?php echo e(__('Move to trash')); ?>" data-confirm="<?php echo e(__('Are You Sure?').' | '.__('This action can not be undone. Do you want to continue?')); ?>" data-confirm-yes="document.getElementById('delete-product-cart-<?php echo e($key); ?>').submit();"><i class="fas fa-times"></i></a>
                                        ...
                                        <?php else: ?>
                                        <tr data-id="<?php echo e($key); ?>" class="alert">
                                            <td >
                                                <?php if(!empty($product['image'])): ?>
                                                    <img alt="" src="<?php echo e($imgpath.$product['image']); ?>" class="" style="width:66px;">
                                                <?php else: ?>
                                            ...
                                            <td data-label="price"><?php echo e(\App\Models\Utility::priceFormat($product['price'])); ?></td>
                                            <td data-label="quantity">
                                                <div class="qty-spinner" data-id="<?php echo e($key); ?>">
                                                    <button type="button" class="quantity-decrement qty-minus product_qty">
                                                        <svg width="12" height="2" viewBox="0 0 12 2" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="checkout-box">
                <div class="row align-items-center">
                    <div class="col-md-8 col-12">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('user-address.useraddress',$store->slug)); ?>" class="checkout-btn">
                                <?php echo e(__('Proceed to checkout')); ?>
                    ...
                    <div class="col-md-4 col-12">
                        <div class="price-bar">
                            ...
                            <span><?php echo e(\App\Models\Utility::priceFormat(!empty($total)?$total:0)); ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-12 col-12">
                    <div class="empty-cart">
                        ...
                        <h4><?php echo e(__('Your cart is empty')); ?>.</h4>
                        <p>
                        ...
                        <a href="<?php echo e(route('store.slug',$store->slug)); ?>" class="cart-btn">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('storefront.layout.theme1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/chacom32/deathcommerce.com/resources/views/storefront/theme1/cart.blade.php ENDPATH**/ ?>