    ...
    <ul class="nav nav-pills cust-nav rounded  mb-3" id="pills-tab" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="header" data-bs-toggle="pill" href="#pills-header" role="tab"
                aria-controls="pills-header" aria-selected="true"><?php echo e(__('Header')); ?></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="home" data-bs-toggle="pill" href="#pills-home" role="tab"
                aria-controls="pills-home" aria-selected="false"><?php echo e(__('Home')); ?></a>
        </li>
        <?php if($theme !== 'theme3' && $theme !== 'theme8' && $theme !== 'theme9'): ?>
        <li class="nav-item">
            <a class="nav-link" id="brand" data-bs-toggle="pill" href="#pills-brand" role="tab"
                aria-controls="pills-brand" aria-selected="false"><?php echo e(__('Brand')); ?></a>
        </li>
        <?php endif; ?>
        <?php if($theme == 'theme8' || $theme == '$theme7' || $theme == 'theme9' ||$theme == 'theme10'): ?>
            <li class="nav-item">
                <a class="nav-link" id="product" data-bs-toggle="pill" href="#pills-product" role="tab"
                    aria-controls="pills-product" aria-selected="false"><?php echo e(__('Product')); ?></a>
            </li>
        <?php endif; ?>
        <li class="nav-item">
            <a class="nav-link" id="footer" data-bs-toggle="pill" href="#pills-footer" role="tab"
                aria-controls="pills-footer" aria-selected="false"><?php echo e(__('Footer')); ?></a>
        </li>
    </ul>
<?php $__env->stopSection(); ?>
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade active show" id="pills-header" role="tabpanel" aria-labelledby="pills-header">
                            ...
                            <div class="row">
                                ...
                                <?php if($theme == 'theme1' || $theme == 'theme6' || $theme == 'theme7' || $theme == 'theme8' || $theme == 'theme9' || $theme == 'theme10'): ?>
                                    <?php
                                        $storethemesetting = \App\Models\Utility::demoStoreThemeSetting($store->id, $store->theme_dir);
                                    ?>
                                    <div class="col-lg-6">
                                        <div class="d-flex mb-3 align-items-center justify-content-between">
                                            <h4 class="mb-0"><?php echo e(__('Top Bar Setting')); ?></h4>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <?php $__currentLoopData = $getStoreThemeSetting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $json_key => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if($section['section_name'] == 'Banner-Image'): ?>
                                        ...
                                        <div class="col-lg-6">
                                            <?php if($json_key == 0 || ($json_key - 1 > -1 && $getStoreThemeSetting[$json_key - 1]['section_slug'] != $section['section_slug'])): ?>
                                                <div class="d-flex mb-3 align-items-center justify-content-between">
                                                    <h4 class="mb-0"><?php echo e($section['section_name']); ?> </h4>
                                                    <div class="form-check form-switch custom-switch-v1">
                                                        <input type="hidden"
                                                            ...
                                                            <?php $__currentLoopData = $section['inner-list']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inner_list_key => $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label
                                                                                ...
                                                                                ?>
                                                                            <?php if($section['array_type'] == 'multi-inner-list'): ?>
                                                                                <textarea name="array[<?php echo e($json_key); ?>][<?php echo e($field['field_slug']); ?>][<?php echo e($i); ?>]" id=""
                                                                                    class="form-control" rows="3" placeholder="<?php echo e($field['field_help_text']); ?>"><?php echo e($checked1); ?></textarea>
                                                                            <?php else: ?>
                                                                                <textarea name="array[<?php echo e($json_key); ?>][inner-list][<?php echo e($inner_list_key); ?>][field_default_text]" id=""
                                                                                    class="form-control" rows="3" placeholder="<?php echo e($field['field_help_text']); ?>"><?php echo e($field['field_default_text']); ?></textarea>
                                                                            <?php endif; ?>
                                                                        </div>
                                                                    </div>
                                                                <?php endif; ?>
                                                                <?php if($field['field_type'] == 'photo upload'): ?>
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <?php else: ?>
                                                                        style="width: auto; height: 50px;" <?php endif; ?>
                                                                                <?php if($field['field_slug'] == 'homepage-footer-logo'): ?> style="width: auto; height: 80px;"
                                                                        <?php else: ?>
                                                                        style="width: 200px; height: 200px;" <?php endif; ?>>
                                                                        <?php endif; ?>
                                ...
                                <?php if($theme !== 'theme3'): ?>
                                    <div class="col-lg-6">
                                        <?php $__currentLoopData = $getStoreThemeSetting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $json_key => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            ?>
                                            <?php if($section['section_name'] == 'Home-Header'): ?>
                                                <?php if($json_key == 0 || ($json_key - 1 > -1 && $getStoreThemeSetting[$json_key - 1]['section_slug'] != $section['section_slug'])): ?>
                                                    <div class="d-flex mb-3 align-items-center justify-content-between">
                                                        <h4 class="mb-0"><?php echo e($section['section_name']); ?> </h4>
                                                        <div class="form-check form-switch custom-switch-v1">
                                                                            ...
                                                                            <?php else: ?>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label
                                                                                        class="form-label"><?php echo e($field['field_name']); ?></label>
                                                                                        <input type="hidden" name="array[<?php echo e($json_key); ?>][inner-list][<?php echo e($inner_list_key); ?>][field_prev_text]" value="<?php echo e($field['field_default_text']); ?>">
                                                                                    <input type="file" name="array[<?php echo e($json_key); ?>][inner-list][<?php echo e($inner_list_key); ?>][field_default_text]" class="form-control" placeholder="<?php echo e($field['field_help_text']); ?>">
                                                                                </div>
                                                                                <img src="<?php echo e($imgdisplay); ?><?php echo e($field['field_default_text']); ?> "
                                                                                    id="<?php echo e($field['field_slug'] == 'header-tag' || $field['field_slug'] == 'product-header-tag' || $field['field_slug'] == 'tag-image' || $field['field_slug'] == 'homepage-footer-logo8' || $field['field_slug'] == 'homepage-category-tag-image' ? 'shadow-img' : ''); ?>"
                                                                                    class="<?php echo e($field['field_slug'] == 'homepage-category-tag-image' ? 'homepage-category-tag-image' : ''); ?>"
                    ...
                    <div class="tab-pane fade" id="pills-home" role="tabpanel" aria-labelledby="pills-home">
                        <div class="row">
                            ...
                            <?php $__currentLoopData = $getStoreThemeSetting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $json_key => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if($section['section_name'] == 'Home-Email-Subscriber'): ?>
                                    <input type="hidden" name="array[<?php echo e($json_key); ?>][section_name]"
                                    value="<?php echo e($section['section_name']); ?>">
                                    <input type="hidden" name="array[<?php echo e($json_key); ?>][section_slug]"
                                        value="<?php echo e($section['section_slug']); ?>">
                            ...
                            <?php $__currentLoopData = $getStoreThemeSetting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $json_key => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <?php if($section['section_name'] == 'Home-Categories'): ?>
                                    <input type="hidden" name="array[<?php echo e($json_key); ?>][section_name]"
                                    value="<?php echo e($section['section_name']); ?>">
                                    <input type="hidden" name="array[<?php echo e($json_key); ?>][section_slug]"
                                        value="<?php echo e($section['section_slug']); ?>">
                            ...
                            <?php if($theme !== 'theme10'): ?>
                                <div class="col-lg-6">
                                    <?php $__currentLoopData = $getStoreThemeSetting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $json_key => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <?php if($section['section_name'] == 'Home-Promotions'): ?>
                                            <?php if($json_key == 0 || ($json_key - 1 > -1 && $getStoreThemeSetting[$json_key - 1]['section_slug'] != $section['section_slug'])): ?>
                                                <div class="d-flex mb-3 align-items-center justify-content-between">
                                                    <h4 class="mb-0"><?php echo e($section['section_name']); ?> </h4>
                                                    <div class="form-check form-switch custom-switch-v1">
                            ...
                            <div class="col-lg-6">
                                <?php $__currentLoopData = $getStoreThemeSetting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $json_key => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <?php if($section['section_name'] == 'Home-Testimonial'): ?>
                                        <?php if($json_key == 0 || ($json_key - 1 > -1 && $getStoreThemeSetting[$json_key - 1]['section_slug'] != $section['section_slug'])): ?>
                                            <div class="d-flex mb-3 align-items-center justify-content-between">
                                                <h4 class="mb-0"><?php echo e($section['section_name']); ?> </h4>
                                                <div class="form-check form-switch custom-switch-v1">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="form-check form-switch custom-switch-v1">
                                                                            <label class="form-check-label"
                                                                                for="array[ <?php echo e($section['section_slug']); ?>][<?php echo e($field['field_slug']); ?>]"><?php echo e($field['field_name']); ?></label>
                                                                            <?php if($section['array_type'] == 'multi-inner-list'): ?>
                                                                                <?php
                                                                                    $checked1 = '';
                    ...
                    <div class="tab-pane fade" id="pills-brand" role="tabpanel" aria-labelledby="pills-brand">
                        <div class="row">
                            ...
                            <?php $__currentLoopData = $getStoreThemeSetting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $json_key => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <?php if($section['section_name'] == 'Home-Brand-Logo' || $section['section_name'] == 'Quote'): ?>
                                    <input type="hidden" name="array[<?php echo e($json_key); ?>][section_name]"
                                    value="<?php echo e($section['section_name']); ?>">
                                    <input type="hidden" name="array[<?php echo e($json_key); ?>][section_slug]"
                                        value="<?php echo e($section['section_slug']); ?>">
                                                                                ...
                                                                                <div class="row align-items-center">
                                                                                    <div class="col ml-n2">
                                                                                        <p class="card-text small text-muted">
                                                                                            <input type="hidden"
                                                                                                name='array[<?php echo e($json_key); ?>][prev_image][]'
                                                                                                value="<?php echo e($file_pathh); ?>">
                                                                                            <img class="rounded"
                                                                                    ...
                                                                                    <div class="col-auto actions">
                                                                                        <a name="deleteRecord"
                                                                                            ...
                                                                                            data-name="<?php echo e('/storage/uploads/' . $file_pathh); ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <?php $__currentLoopData = $getStoreThemeSetting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $json_key => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <?php if($section['section_name'] == 'Home-Footer-1'): ?>
                                        <?php if($json_key == 0 || ($json_key - 1 > -1 && $getStoreThemeSetting[$json_key - 1]['section_slug'] != $section['section_slug'])): ?>
                                            <div class="d-flex mb-3 align-items-center justify-content-between">
                                                <h4 class="mb-0"><?php echo e($section['section_name']); ?> </h4>
                                                <div class="form-check form-switch custom-switch-v1">
                            ...
                            <div class="col-lg-6">
                                <?php $__currentLoopData = $getStoreThemeSetting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $json_key => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <?php if($section['section_name'] == 'Home-Footer-2'): ?>
                                        <?php if($json_key == 0 || ($json_key - 1 > -1 && $getStoreThemeSetting[$json_key - 1]['section_slug'] != $section['section_slug'])): ?>
                                            <div class="d-flex mb-3 align-items-center justify-content-between">
                                                <h4 class="mb-0"><?php echo e($section['section_name']); ?> </h4>
                                                <div class="form-check form-switch custom-switch-v1">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/chacom32/deathcommerce.com/resources/views/settings/edit_theme.blade.php ENDPATH**/ ?>