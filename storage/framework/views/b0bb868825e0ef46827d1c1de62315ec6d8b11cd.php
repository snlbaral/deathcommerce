...
<div class="wrapper">
    <section class="login-section padding-top">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-12 col-12">
                    <div class="login-form">
                        <h3><?php echo e(__('Customer')); ?> <span> <?php echo e(__('Register')); ?> </h3>
                            <?php echo Form::open(array('route' => array('store.userstore', $slug)), ['method' => 'post']); ?>
...
unset($__errorArgs, $__bag); ?>
                                <div class="last-btns">
                                    <button type="submit" class="login-btn-2 btn btn-primary"><?php echo e(__('Register')); ?></button>
                                    <p><?php echo e(__('By using the system, you accept the')); ?> 
                                        <a href="">  <?php echo e(__('Privacy Policy')); ?></a> <?php echo e(__('and')); ?> <a href=""> <?php echo e(__('System Regulations.')); ?> </a>
                                    </p>
                                </div>
                                <p class="register-btn"><?php echo e(__('Already registered ?')); ?><a href="<?php echo e(route('customer.loginform',$slug)); ?>"><?php echo e(__('Login')); ?></a></p>
                            <?php echo Form::close(); ?>
...
<?php echo $__env->make('storefront.layout.theme1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/chacom32/deathcommerce.com/resources/views/storefront/theme1/user/create.blade.php ENDPATH**/ ?>