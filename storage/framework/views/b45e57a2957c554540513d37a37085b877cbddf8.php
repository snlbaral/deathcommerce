...
<?php $__env->startSection('action-btn'); ?>
    ...
    (isset($admin_payments_setting['is_payfast_enabled']) && $admin_payments_setting['is_payfast_enabled'] == 'on')
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Plans')): ?>
                <a class="btn btn-sm btn-icon  btn-primary me-2 text-white" data-url="<?php echo e(route('plans.create')); ?>" data-title="<?php echo e(__('Add Plan')); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Add Plan')); ?>">
                    ...
                    <div class="card price-card price-1 wow animate__fadeInUp" data-wow-delay="0.2s" style="
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-end">
                                <div class="">
                                    <?php if( \Auth::user()->type == 'super admin'): ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Plans')): ?>
                                            <div class="d-inline-flex align-items-center">
                                                <a class="btn btn-sm btn-icon  bg-light-secondary me-2" data-url="<?php echo e(route('plans.edit',$plan->id)); ?>" data-title="<?php echo e(__('Edit Plan')); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Edit')); ?>">
                            ...
                            <div class="row mb-3">
                                <div class="col-4 text-center">
                                    <?php if($plan->max_products == '-1'): ?>
                                        <span class="h5 mb-0"><?php echo e(__('Lifetime')); ?></span>
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/chacom32/deathcommerce.com/resources/views/plans/index.blade.php ENDPATH**/ ?>