    ...
    <div class="min-vh-100 h-100vh py-5 d-flex align-items-center bg-gradient-info">
        ...
        <div class="container position-relative zindex-100">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6">
                    <h6 class="display-1 mb-3 font-weight-600"><?php echo e(__('419')); ?></h6>
...
<?php echo $__env->make('errors::minimal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/chacom32/deathcommerce.com/resources/views/errors/419.blade.php ENDPATH**/ ?>