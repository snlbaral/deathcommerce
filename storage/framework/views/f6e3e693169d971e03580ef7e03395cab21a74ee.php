            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-12 col-12">
                    <div class="login-form">
                        <h3><?php echo e(__('Customer')); ?> <span> <?php echo e(__('login')); ?></h3>
                            <?php echo Form::open(array('route' => array('customer.login', $slug,(!empty($is_cart) && $is_cart==true)?$is_cart:false)),['method'=>'POST']); ?>
                                ...
                                <div class="last-btns">
                                    <button type="submit" class="login-btn-2 btn btn-primary"><?php echo e(__('Sign In')); ?></button>
                            ...
                            <p class="register-btn"><?php echo e(__('Dont have account ?')); ?><a href="<?php echo e(route('store.usercreate',$slug)); ?>"><?php echo e(__('Register')); ?></a></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('storefront.layout.theme1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/chacom32/deathcommerce.com/resources/views/storefront/theme1/user/login.blade.php ENDPATH**/ ?>